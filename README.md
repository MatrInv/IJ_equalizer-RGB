These IMAGEJ plugins are made to equalize or stretch the histogram of a colored picture and are supposed to be used on RGB images, like shown in the directory "img_tests".
